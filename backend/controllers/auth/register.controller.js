...
export const register = asyncHandler(async (req, res, next) => {
  ...
  try {
    await sendEmail({
      ...
      subject: "Welcome to GFG Shopping!",
      message: `Hi ${createdUser.username}, welcome to GFG Shopping!`,
      html: `<h1>Welcome, ${createdUser.username}!</h1><p>We are glad to have you at GFG Shopping.</p>`,
    });
  } catch (emailError) {
